        ...
        <div class="container">
            <div class="menu-content">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="/"><img src="/web/public/images/logo.jpg" alt=""></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <div class="i_con">
                        <ul class="nav navbar-nav text-uppercase">
                            <li><a href="/"><img src="public/images/logo.png" alt="альтернативный текст" /></a></li>
                            <li><a href="/">Home</a></li>
                            <li><a href="/modules/admin/login">Login</a></li>
    ...
    <footer class="footer-widget-section">
        ...
        <div class="footer-copy">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">&copy; 2021 <a href="#">PRO, </a> Built with <i
